...
##### 财务系统
  * [芸税通 · 芸慧科技](http://gw.yunhuitax.com/) — 智能财税系统，专门为代理记账公司等涉税服务机构打造，助力企业构建企业财税数字账户。无需更换记账系统，也可以无缝对接使用智能申报系统。 （工作地点：北京、郑州、西安、广州。技术栈：Java、.NET、VUE、Python等）
...
##### 电商工具
  ...
  * 找化客 — 
  * [智客牛](https://www.zhikeniu.com) — 微商城，门店、会员、促销、分销裂变、数字营销、AI客服、企微SCRM。 （工作地点：上海。技术栈：JAVA）
  * 直客通 —  
---
## 泛ERP
...
##### 交通出行-物流运输
  ...
  * 云鸟配送 —  
  * 运去哪 —  
  * [智通三千 · 零浩网络科技](http://www.zt3000.com/) — 网约货车、企业物流优化平台，让企业与车辆面对面直接交易，最近的空车，真实的货源，透明的报价，真正做到方便，快捷，又省钱。 （工作地点：南京。技术栈：Java）
...
##### 旅游-酒店
  ...
  * [智客牛](https://www.zhikeniu.com) — 客房预订、日历房、钟点房、今夜特价房、微商城、会员体系、促销、分销裂变、数字营销、AI客服、企微SCRM。 （工作地点：上海。技术栈：JAVA）
  * 住哲 —  
...
##### 能源-电力-矿产-自然资源
  ...
  * 易加油 —  
  * 油战线 —  
  * [智慧油客 · 潍坊智慧油客网络科技有限公司](http://www.smartyoke.com/comInfo.html) — 致力于成为中国乃至全球能源零售行业智慧化运营系统与最佳解决方案的首选品牌运营服务商。 （工作地点：潍坊。技术栈：Java）
...
##### 体育旅游
  ...
  * 中羽运动 —  
  * 自我游 —  
  * [阿旅科技](https://www.alvcloud.com/) — 酒店预订，微商城，会员、促销、分销裂变、数字营销、AI客服、企微SCRM。 （工作地点：上海。技术栈：JAVA）
...
##### aPaaS
  ...
  * 开客 —  
  * 领码 —  
  * [明道云](https://mingdao.com/) — 零代码灵活定制，满足多种业务需求，工作表（25种字段类型），视图，角色，工作流，统计（10秒做一个统计报表），支持私有部署，明道云获得中软网两项无代码厂商荣誉，1000+标杆企业正在使用明道云。 （工作地点：上海。技术栈：JAVA）
  * 明源云 —  
  * 纳比云 —  
  * 牛刀云 —  
  * 拍乐云Pano —  
...
##### CRM
  ...
  * Percentage —  
  * 普丘系统 — 
  * [企微智客 · 智客牛](https://www.zhikeniu.com) — 企微智客SCRM、AI客服、微商城，门店、会员、促销、分销裂变、数字营销。 （工作地点：上海。技术栈：JAVA）
  * 乾启大数据 —  
  * 乾通嗖嗖 —  
  * 瑞泰信息 —  
  * 神州云动 —  
  ...
  * [爱客CRM · 微问家](https://www.ikcrm.com/) -- 专注中小企业crm，解决企业销售过程管理、销售支持管理、客户资源管理。是企业轻量化、高效化的销售管理利器。 （工作地点：上海。技术栈：Ruby）
  * 小裂变 —  
  * 小满科技 —  
  * 销售易 —  
...
##### 培训管理系统
  * [51CTO学院企业版 · 无忧创想信息技术](https://b.51cto.com/product) — 根据企业和技术团队的实际业务需求，总结出岗位或技术线上培训模板，选择培训模板，指定员工或团队，只需 1分钟即可部署一场线上培训。 （工作地点：北京）
  * [爱上学习 · 人鼎人教育科技](http://www.ishangstudy.com/) — 是国内一家真正致力于在线游戏化学习的移动互联网科技公司。企业个性化首页、企业直播、一键式考试、同事圈、公告板块、经验库、5分钟微课程、章节系统性课程、组合课程生成、灵活的角色配置、学习统计。 （工作地点：上海。技术栈：PHP）
  * [道一云 · 道一信息技术](https://wbg.do1.com.cn/) — 一站式智能办公平台，让工作更高效。OA、CRM、HR、工作流、任务分派、云大学、问卷调研、人事考核、企业云盘、费控报销。基于企业微信，助力企业轻松搭建移动工作平台及营销服务平台。 （工作地点：广州。技术栈：Java）
    * [道一云大学](https://wbg.do1.com.cn/) — 小程序直播、录播培训、考学联动人脸识别监考、游戏式/闯关式学习地图。
    * [道一云SCRM](https://wbg.do1.com.cn/scrm/) — 构建私域流量获客引擎, 实现业务指数级增长。引流获客：企微裂变、渠道活码、抽奖拓客、自动标签、红包拓客、个性欢迎语、社群裂变、标签拉群。客户跟进：跟进记录、互动轨迹、客户公海池、跟进提醒、营销话术库、聊天侧边栏、会话存档、聊天打标签。互动营销：红包营销、自动拉群、短信营销、带货直播、高级群发、企业朋友圈。数据分析：渠道获客统计、客户跟进统计、客户流失统计、社群运营统计。风控质检：客户看板、离职继承、标签管理、敏感词监控。
    * [道一云CRM](https://wbg.do1.com.cn/crm/) — 从线索到回款的销售全流程管理。企业小站点、微信互通、导入线索、客户管理、拜访管理、商机管理、合同回款开票管理。拥有1亿条客户工商、司法、招聘、金融信息和联系方式。
    * [道一云HR](https://wbg.do1.com.cn/hr/) — 一站式人力资源服务平台。人才招聘：人才储备、简历库、面试流程、员工内推、校园招聘。组织人事：员工档案、预警提醒、人事报表、员工培训、薪酬考勤、绩效晋升、企业文化等。
    * [道一云OA](https://wbg.do1.com.cn/oa/) — 一站式智能OA，全面解决日常办公需求，让工作更高效，管理更智慧。
  * 钉学科技 —  
  * 兜行 —  
  * 岗易网 —  
  * 高顿财税学院 —  
  ...
  * 微课帮 —  
  * 微一案 —  
  * [小鹅通 · 小鹅网络技术](https://www.xiaoe-tech.com/companyProfile) — 是一款集品牌营销、知识产品交付、用户管理和商业变现为一体的数字化工具，为有线上经营需求的企业提供一站式技术服务，助力企业完成数字化转型。知识付费、教育培训、企业培训、直播产品。 （工作地点：深圳。技术栈：PHP、Vue）
  * 英盛网 —  
  * 云开科技 —  
  * 云学堂 —  
  * 职行力 —  
...
##### 云供应链
  * [51订货网 · 江苏蜂云供应链管理有限公司](http://www.51dh.com.cn/site/login) — 厂家渠道；一台起送、闪电发货；退货无忧、换货便捷；在线客服、专属服务；销售登记、库存管理。 （工作地点：南京。技术栈：PHP）
  * [上海科箭软件](https://www.qt-asia.com/) — 科箭供应链管理云平台 Power SCM Cloud，是一个整合订单管理系统（OMS）、运输管理系统（TMS）、仓储管理系统（WMS）等供应链流程的云解决方案。一体化云平台打破信息孤岛，通过整合仓配流程、协同各方资源，从而构建透明的数字化供应链网络。 （工作地点：西安。技术栈：.net）
    * [科箭TMS云](https://www.qt-asia.com/tms.html) — 运输管理系统。连接运输上下游，透明供应链数据；运输计划及运费结算自动化，大幅减低管理成本；无缝整合WMS云，实现仓配一体化；2-4周快速上线，提高客户服务水平。
    * [科箭wms云](https://www.qt-asia.com/wms.html) — 仓储管理系统。通过对仓库库位、作业单元、作业单据和指令的全条码化管理，实现物流、单据流、数据流同步统一，库存更准确，物品可跟踪。无缝整合TMS云，实现订单库存可视化、可根据运输安排提前备货，缓解仓库压力，提升配送时效。支持复杂约束条件的波次单模板，实现集中拣货，节省大量人力；根据货位路线顺序推荐拣货路径，显著提高拣配货效率。入库管理、库存管理、出库管理、人力管理、条码管理。
    * [科箭oms云](https://www.qt-asia.com/oms.html) — 订单管理系统。帮助客户处理从订单接收到费用结算的全生命周期管理，通过订单中心汇集内、外部多渠道订单，OMS云与WMS云、TMS云无缝集成。支持来自网站、移动端、B2B或B2C电商平台、呼叫中心、ERP系统及其他内外部订单的集中处理；系统基于预设规则，通过管理订单合并或分拆、优先级、释放、冻结或取消等状态，满足客户需求的同时，实现供应链库存的优化管理。供应链合作伙伴通过网页或移动端，参与订单的交付和实时数据采集；应收应付凭证或导入来自其他物流服务的费用，可按单按客户等条件汇总，同时根据业务规则进行费用分摊。
    * [科箭Ams云](https://www.qt-asia.com/ams.html) — 月台司机管理系统。基于月台、库区能力，预设预约规则，有序安排到货与发货车辆预约；支持多种方式的预约，照单预约、无单预约、循环预约等；按预约安排进行出入场、装卸、排队管理；通过与仓库、运输进行协同，优化预约计划并提供预警与分析
  * [oneTMS · oTMS上海先烁信息科技有限公司](http://www.otms.com/otms-products/one-tms/) — 运输管理系统。从发货到签收，订单全流程管理；实时在途追踪，确保信息真实可信；强大计费引擎与完善的对账功能，支持一键生成账单，在线对账，大幅节省对账时间；运输商务智能，提供免费标准运输报表；快递集中管理；冷链解决方案；运费审计。 （工作地点：上海）
  * [订货宝 · 成都阿商信息技术有限公司](http://www.scbs818.com/dhb.html) — 通过订货宝，快速地帮您搭建专属的渠道订货平台，电脑、APP、微信皆可使用。通过订货端展示您的商品让客户自主下单，管理端快速地处理接单、审核、付款、发货等订单流程；域名、登录页、订货页、APP等均可定制为企业品牌形象。 （工作地点：成都。技术栈：PHP）
  * [订货帮 · 广东优点云计算科技有限公司](http://www.udean.net/product.html) — 订货帮围绕企业内部协同和上下游协同，提供全渠道营销解决方案，实现交易、营销、支付、数据的自动化。订货商城、商品管理、营销管理、智能报表、订单管理、库存管理、资金管理、供应商管理、客户管理、采购管理、分销管理、千人千店。 （工作地点：中山。技术栈：.net）
  * [富基标商 · 北京富基标商流通信息科技有限公司](http://www.bfuture.com.cn/index.htm) — 富基标商针对全程供应链上不同伙伴（包括制造商、分销商、物流服务商、零售商、消费者）提供了完整的全程流通随需应变解决方案，订单流、资金流、物流、全程监控、实时KPI分析、自主ROI计算等能力。 （工作地点：北京。技术栈：Java）
  * [观麦科技 · 深圳市观麦网络科技有限公司](https://www.guanmai.cn/about/) — 2016年，建成观麦SaaS服务平台。帮助传统配送企业转型升级。2018年8月，观麦上线发布中央厨房专用版SaaS系统，为生鲜加工企业提供SaaS系统服务。同年12月，观麦牵手有赞，实现生鲜前店后仓一体化运作。2019年8月，观麦科技正式发布供港专用版SAAS系统，为供港企业提供更为专业化的管理服务。截止2020年9月份，观麦服务的客户已突破6000家，遍布全球，在北美、东南亚等市场均有客户。 （工作地点：深圳市南山区。技术栈：Python、React）
  * [金科信综合物流云 · 深圳市金科信软件开发有限公司](http://www.cttms.com/) — 金科信专注港口综合物流云平台的开发与运营，以集装箱物流服务为核心为中国及东南亚4000多家客户提供云服务，客户覆盖运输车队、仓储企业、报关行、堆场企业、货代企业、多式联运企业等。通过数据智能、网络协同提升物流企业在线能力、可视能力、协同能力，切实帮助物流企业降本增效、优化服务，使其成为自适应智慧物流供应链的一部分，从而推动全球物流行业的发展。 （工作地点：深圳）
  * [隆道云 · 北京隆道网络科技有限公司](https://www.longdaoyun.com/) — 自成立之初，隆道即以“打造一个有价值的企业”为愿景，并以用数字化提升采购招标和供应链管理效率为使命，致力于打造基于大数据和平台化的 “知”“行”合一平台，帮助企业完成采供内外协同工作，同时为企业用户打造适合自身业务特殊需求的电子化采购系统。功能包括智能采购；电子招标；五大资源库：“产品库”、“价格库”、“商机库”、“企业库”和“专家库”；供应商服务。 （工作地点：北京）
  * [企企通 · 深圳市企企通科技有限公司](https://srm.51qqt.com/supplier.html) — 企企通供应商管理基于供应商生命周期闭环的先进理念，为您企业的供应链赋能，打造企业与供应商之间「业务」、「系统」和「人」三个层面的协同，助力企业全面缩短业务管理周期时间，减低企业采购成本，提升采购质量和现金管理水平，打造绿色智能供应链。供应商注册及准入、供应商档案及维护、物料认证及资质管理、供应商绩效管理、供应商评估分级、供应商淘汰整改。 （工作地点：深圳。技术栈：Java）
    * [供应链金融 · 企企通](https://scf.51qqt.com/) — 为企业及其供应商提供灵活全面的供应链金融及保理解决方案，帮助企业节约成本，提升利润。企利通：应付账款提前支付的供应链金融系统，可获得提前支付折扣收益；企保通：保理业务的供应链金融系统平台，全线上流程和大数据分析系统；企融通：提供订单融资、ERP融资的供应链融资系统平台；企票通：承兑汇票贴现服务的票据系统平台，一款创新型供应链金融系统。
  * [商越 · 北京商越网络科技有限公司](https://www.sunyur.com/product/mall/index.html) — 针对企业非生产采购需求多散杂、供应商分散、对账难等问题，商越为企业打造专属的采购商城，全面提升企业采购管理水平。 （工作地点：北京。技术栈：Java）
    * [商城采购 · 商越](https://www.sunyur.com/product/mall/index.html) — 通过SaaS应用，连接自有供应商和主流电商，建立采购标准化；从需求提报到结算付款，全流程自动化、可追踪；采供双方执行协议采购，价格透明；大量减少采购事务型工作，专注运营。
    * [电商采购 · 商越](https://www.sunyur.com/product/e-commerce/index.html) — 通过SaaS应用对接行业优质电商平台，并通过开放平台提供标准API接口，企业无需考虑对接技术和维护成本，可对接更多潜在供应商，可无障碍引入新供应商。
    * [寻源采购 · 商越](https://www.sunyur.com/product/sourcing/index.html) — 寻源采购，从需求侧驱动构建全网寻源，连接固买、宏伟供应链、1688等全网资源，为企业解决实际问题。
    * [采购协同 · 商越](https://www.sunyur.com/product/coordination/index.html) — 商越采购SaaS平台可实现采购活动自动化、标准化，采购端与供应商协同更智能，持续提高采购效率。订单协同、发运接收协同、结算对账协同、发票协同、支付协同。
    * [采购中台 · 商越](https://www.sunyur.com/product/center/index.html) — 会员中心、商品中心、订单中心、支付中心、结算中心、发票中心、对账服务、主数据、工作流、角色权限、消息服务、云客服。ERP、财务、SRM、OA、MRP、WMS、TMS。
  * 跳羚科技 —  
  * 同徽信息 —  
  * U订货 —  
  * 我来医健 —  
  * 新海科技 —  
  * [雅澳供应链 · 上海雅澳供应链管理有限公司](http://www.your-scm.com/) — 提供综合供应链解决方案，综合物流、智能云仓、航空冷链、供应链金融于一体的大型综合供应链服务商。 （工作地点：上海。技术栈：PHP）
  * 易订货 —  
  * 依链科技 —  
  * 铱云科技 —  
  * 宥迅联 —  
...
##### SCRM
  ...
  * 兔展scrm —  
  * 网聚宝 —  
  * [卫瓴 · 企微助手](https://www.weiling.cn) — 全新一代的协同CRM，助力企业业绩提升。以企业微信为基础，涵盖客户关系管理、销售赋能、私域快速引流、私域精细化运营、社群运营等功能，通过多渠道一键获客、浏览内容检测、全维度客户画像、员工智能管理、团队高效协同，驱动企业销售增长。 （工作地点：上海。技术栈：Java、React、Vue）
  * 微动天下 —  
  * 维客云 —  
  * 微梦传媒 —  
  * 微圈 —  
...
##### 智能巡检
  * [巡检卫士 · 沈阳明致软件有限公司](http://xunjian.meanssoft.com/index.html) — 巡检时在关键点上放一个巡检标志牌，巡检人员在智能手机上安装APP客户端，扫描或读取标牌，然后按照屏幕上的要求进行现场检查，拍照、录像、填写记录。切实保证企业的巡检管理制度能够有效落地执行。做到巡检有计划、有内容、有结果、有审核、有依据，过程严谨、操作规范，避免漏检、错检情况发生。
  * [JMS智能巡检专家 · 南京及时码网络科技有限公司](http://jishima1.51sole.com/companynewsdetail_129752154.htm) — 基于全新技术的GIS平台，形成线路及设施、隐患、线路重要位置分布一览图。维护人员通过手机端智能巡检app可免去了巡维数据的二次录入，减轻了工作量，减少差错。管理者通过系统的实时在线查看功能，实现了人员在线动态监控。有效减少巡检及盯防的随意性，将巡检及盯防的完成率及轨迹直观体现。常用的电子地图缺乏行业所关注的地理信息（如过江过河、事故多发等），而通过本系统可快速、自主建立客户业务所关注的地理信息图层，为抢修、维护、规划提供更多的决策信息。重要测量数据、工程图纸、竣工文档、抢修方案等进行统一集中的信息管理，实现快速查阅或更新。
  * [金万码科技](https://appxunjian.com/) — 巡检方式更灵活：二维码、NFC、GPS、蓝牙四大巡检方式。值勤报表一键查看：巡检执勤人员按计划按班次定时到达指定地点后，通过手机巡检APP软件读取数据实时上传， 管理者登陆管理软件值勤报表一键查看。
